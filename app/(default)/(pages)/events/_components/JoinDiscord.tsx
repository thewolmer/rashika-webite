...
import { HiMiniMoon, HiOutlineArrowUpRight } from 'react-icons/hi2';
  ...
  if (!data || isLoading)
    return (
      <div className="relative flex w-full items-center justify-center overflow-hidden p-5">
        ...
        <div className="absolute rounded-2xl bg-foreground/5 px-4 py-4 shadow-2xl backdrop-blur-3xl md:px-32 md:py-28">
          <h3 className="flex flex-col items-center font-gerbil text-base font-extrabold md:text-4xl">
  ...
  return (
    <div className="relative flex w-full items-center justify-center p-5">
      ...
      <div className="absolute rounded-2xl bg-foreground/5 px-4 py-4 shadow-2xl backdrop-blur-3xl md:px-32 md:py-28">
        ...
        <Link className="group mt-5 flex items-center justify-center" href={data.instant_invite}>
          <Button className="font-inconsolata font-extrabold md:text-xl">
            Take me there
